...
-- Script date 2012/5/29 23:04:23
...
--
-- Definition for procedure getCandidateTalentNumForSpecialHunter_EnterpriseUser
--
DROP PROCEDURE IF EXISTS getCandidateTalentNumForSpecialHunter_EnterpriseUser$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getCandidateTalentNumForSpecialHunter_EnterpriseUser(IN iHunter INT, IN iEnterpriseUser INT)
...
--
-- Definition for procedure getCandidateTalentNumForSpecialJob
--
DROP PROCEDURE IF EXISTS getCandidateTalentNumForSpecialJob$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getCandidateTalentNumForSpecialJob(IN iJob INT)
  COMMENT '取得特定职位的推荐人数
in:
  iJob
res:
...
--
-- Definition for procedure getChosenTalentNumForSpecialJob
--
DROP PROCEDURE IF EXISTS getChosenTalentNumForSpecialJob$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getChosenTalentNumForSpecialJob(IN iJob INT)
  COMMENT '取得特定职位的成交人数
in:
  iJob
res:
...
--
-- Definition for procedure getCurStatusForSpecialDeal
--
DROP PROCEDURE IF EXISTS getCurStatusForSpecialDeal$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getCurStatusForSpecialDeal(IN iDeal INT)
  COMMENT '取得特定交易当前状态
in:
  iDeal
out:
...
--
-- Definition for procedure getDealSuccessNumForSpecialHunter
--
DROP PROCEDURE IF EXISTS getDealSuccessNumForSpecialHunter$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getDealSuccessNumForSpecialHunter(IN iHunter INT)
  COMMENT '取得特定猎头推荐成功数
in:
  iHunter 猎头id
out:
...
--
-- Definition for procedure getDealSuccessNumForSpecialHunter_EnterpriseUser
--
DROP PROCEDURE IF EXISTS getDealSuccessNumForSpecialHunter_EnterpriseUser$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getDealSuccessNumForSpecialHunter_EnterpriseUser(IN iHunter         INT,
...
--
-- Definition for procedure getEnterpriseListForSpecialHunter
--
DROP PROCEDURE IF EXISTS getEnterpriseListForSpecialHunter$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getEnterpriseListForSpecialHunter(IN iHunter INT, IN iOffset INT, IN iLimit INT)
  COMMENT '取得特定猎头的企业名称列表
in:
  iHunter
  iOffset
  iLimit
...
--
-- Definition for procedure getFitBusinessAreaForSpecialTalent
--
DROP PROCEDURE IF EXISTS getFitBusinessAreaForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getFitBusinessAreaForSpecialTalent(IN iTalent INT)
  COMMENT '取得特定人才的适合商区
in:
  iTalent
out:
...
--
-- Definition for procedure getFitCityForSpecialTalent
--
DROP PROCEDURE IF EXISTS getFitCityForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getFitCityForSpecialTalent(IN iTalent INT)
  COMMENT '取得特定人才的适合城市
in:
  iTalent
out:
...
--
-- Definition for procedure getFitTalentNumForSpecialJob
--
DROP PROCEDURE IF EXISTS getFitTalentNumForSpecialJob$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getFitTalentNumForSpecialJob(IN iJob INT)
  COMMENT '取得特定职位的匹配人数
in:
  iJob
out:
...
BEGIN
  ...
  SET @sql1 = 'SELECT count(*) FROM talent a WHERE';
  SET @sql1 = concat(@sql1, ' a.active = 1 AND');
  IF vSex IS NOT NULL
  THEN
...
--
-- Definition for procedure getHistoryForSpecialDeal
--
DROP PROCEDURE IF EXISTS getHistoryForSpecialDeal$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getHistoryForSpecialDeal(IN iDeal   INT,
                                       IN iOffset INT,
                                       IN iLimit  INT)
  COMMENT '取得特定交易历史状态
in:
...
--
-- Definition for procedure getHistoryForSpecialTalent
--
DROP PROCEDURE IF EXISTS getHistoryForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getHistoryForSpecialTalent(IN iTalent INT,
                                         IN iOffset INT,
                                         IN iLimit  INT)
...
--
-- Definition for procedure getHunterToDoForSpecialTalent
--
DROP PROCEDURE IF EXISTS getHunterToDoForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getHunterToDoForSpecialTalent(IN iTalent INT, IN iOffset INT, IN iLimit INT)
...
--
-- Definition for procedure getInfoForSpecialTalent
--
DROP PROCEDURE IF EXISTS getInfoForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getInfoForSpecialTalent(IN iTalent INT)
  COMMENT '取得特定人才的信息
in:
  iTalent
out:
...
--
-- Definition for procedure getJobListForSpecialEnterpriseUser
--
DROP PROCEDURE IF EXISTS getJobListForSpecialEnterpriseUser$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getJobListForSpecialEnterpriseUser(IN iEnterpriseUser INT, IN iOffset INT, IN iLimit INT)
...
--
-- Definition for procedure getNumForSpecialHunter_enterprise_dealStatus
--
DROP PROCEDURE IF EXISTS getNumForSpecialHunter_enterprise_dealStatus$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getNumForSpecialHunter_enterprise_dealStatus(IN iHunter     INT,
                                                           IN iEnterprise INT,
                                                           IN iStatus     INT)
...
--
-- Definition for procedure getPointForSpecialHunter
--
DROP PROCEDURE IF EXISTS getPointForSpecialHunter$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getPointForSpecialHunter(IN iHunter INT)
  COMMENT '取得特定猎头积分
in:
  iHunter 猎头id
out:
...
--
-- Definition for procedure getSuccessTalentInfoForSpecialHunter_EnterpriseUser
--
DROP PROCEDURE IF EXISTS getSuccessTalentInfoForSpecialHunter_EnterpriseUser$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getSuccessTalentInfoForSpecialHunter_EnterpriseUser(IN iHunter INT, IN iEnterpriseUser INT, IN iOffset INT, IN iLimit INT)
...
--
-- Definition for procedure getTalentForSpecialJobSpecialStatus
--
DROP PROCEDURE IF EXISTS getTalentForSpecialJobSpecialStatus$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getTalentForSpecialJobSpecialStatus(IN iJob    INT,
                                                  IN iStatus INT,
                                                  IN iOffset INT,
                                                  IN iLimit  INT)
...
--
-- Definition for procedure getTalentIdForSpecialCondition
--
DROP PROCEDURE IF EXISTS getTalentIdForSpecialCondition$$
CREATE DEFINER = 'root'@'localhost'
PROCEDURE getTalentIdForSpecialCondition(IN iHunter INT, IN iSex INT, IN iHeightFrom INT, IN iHeightTo INT, IN iEducation INT, IN iAppearance INT, IN iExpression INT, IN iCity INT, IN iBusinessArea INT, IN iOffset INT, IN iLimit INT)
  COMMENT '取得特定条件的人才id
in:
  iSex,
  iHeightFrom,
...
BEGIN
  ...
  SET @sql = 'select id from talent a where a.active = 1';
...
label1:
  LOOP
    ...
    THEN
      LEAVE label1;
    ELSE
      INSERT INTO `enterprise` (`name`, `phone`, `mail`, `address`, `introduction`, `created`) VALUES (concat('企业', i), 12345678, 'enterprise@mail.com', '企业地址sample', '企业介绍sample', NULL);
    END IF;
  END LOOP label1;
...
label1:
  LOOP
    ...
    THEN
      LEAVE label1;
    ELSE
  INSERT INTO `hunter` (`name`, `password`, `fixphone1`, `fixphone2`, `fixphone3`, `mobile`, `personName`, `idNo`, `address`, `bankNo`, `bankName`, `created`) VALUES (concat('猎头', i), '123456', '001', '12345678', '8888', concat('1380000000', i), concat('猎头名', i), concat('320000000000000', i), concat('猎头地址', i), concat('bankno', i), concat('银行名称', i), NULL);
    END IF;
  END LOOP label1;
END
$$
...
label1:
  LOOP
    ...
    THEN
      LEAVE label1;
    ELSE
      INSERT INTO `enterpriseUser` (`name`, `password`, `enterprise`, `created`) VALUES (concat(eName, '_', i), '123456', eId, NULL);
    END IF;
  END LOOP label1;
...
--
-- Definition for function createNewDeal
--
DROP FUNCTION IF EXISTS createNewDeal$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewDeal(iTalent INT, iJob INT, iEnterpriseUser INT, iStatus INT)
  RETURNS int(11)
  COMMENT '创建新交易
in:
  iTalent
...
--
-- Definition for function createNewEnterprise
--
DROP FUNCTION IF EXISTS createNewEnterprise$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewEnterprise(iName VARCHAR(255), iPhone VARCHAR(255), iMail VARCHAR(255), iAddress VARCHAR(255), iIntroduction TEXT)
  RETURNS int(11)
  COMMENT '新建企业
in:
  iName
...
--
-- Definition for function createNewFitBusinessAreaForSpecialTalent
--
DROP FUNCTION IF EXISTS createNewFitBusinessAreaForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewFitBusinessAreaForSpecialTalent(iTalent INT, iBusinessArea INT)
  RETURNS int(11)
  COMMENT '为特定人才创建适合商区
in:
  iTalent
...
--
-- Definition for function createNewFitCityForSpecialTalent
--
DROP FUNCTION IF EXISTS createNewFitCityForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewFitCityForSpecialTalent(iTalent INT, iCity INT)
  RETURNS int(11)
  COMMENT '为特定人才创建适合城市
in:
  iTalent
...
--
-- Definition for function createNewFitIndustryForSpecialTalent
--
DROP FUNCTION IF EXISTS createNewFitIndustryForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewFitIndustryForSpecialTalent(iTalent INT, iIndustry INT)
  RETURNS int(11)
  COMMENT '为特定人才创建适合行业
in:
  iTalent
...
--
-- Definition for function createNewHunter
--
DROP FUNCTION IF EXISTS createNewHunter$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewHunter(iName       VARCHAR(255),
...
--
-- Definition for function createNewStatusForSpecialDeal
--
DROP FUNCTION IF EXISTS createNewStatusForSpecialDeal$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewStatusForSpecialDeal(iDeal INT, iStatus INT, iNote TEXT, iRole VARCHAR(255), iRoleId INT)
  RETURNS tinyint(4)
  COMMENT '为特定交易设置状态
in:
  iDeal
...
--
-- Definition for function createNewTalent
--
DROP FUNCTION IF EXISTS createNewTalent$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewTalent(iHunter INT, iPersonName VARCHAR(255), iBirthYear DATE, iPhotoURL TEXT, iVideoURL TEXT, iSex INT, iMarriage INT, iHeight INT, iEducation INT, iAppearance INT, iExpression INT, iHunterNote TEXT, iRelease INT)
  RETURNS tinyint(1)
  COMMENT '创建新人才
in:
  iHunter,
...
--
-- Definition for function createNewUnfitIndustryForSpecialTalent
--
DROP FUNCTION IF EXISTS createNewUnfitIndustryForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION createNewUnfitIndustryForSpecialTalent(iTalent INT, iIndustry INT)
  RETURNS int(11)
...
--
-- Definition for function updateEnterpriseRemarkForDeal
--
DROP FUNCTION IF EXISTS updateEnterpriseRemarkForDeal$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION updateEnterpriseRemarkForDeal(iDeal INT, iAccurate INT, iCommunication INT, iQuality INT, iEnterpriseRemark TEXT)
  RETURNS int(11)
  COMMENT '企业用户为交易填写评语
in:
  iDeal
...
--
-- Definition for function updateForSpecialTalent
--
DROP FUNCTION IF EXISTS updateForSpecialTalent$$
CREATE DEFINER = 'root'@'localhost'
FUNCTION updateForSpecialTalent(iTalent INT, iPersonName VARCHAR(255), iBirthYear DATE, iPhotoURL TEXT, iVideoURL TEXT, iSex INT, iMarriage INT, iHeight INT, iEducation INT, iAppearance INT, iExpression INT, iHunterNote TEXT, iRelease INT)
  RETURNS int(11)
  COMMENT '更新特定人才信息
in:
  iTalent,
